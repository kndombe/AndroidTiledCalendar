...
import com.tiledcalendar.tiledmonthview.TiledMonthView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tiledMonth.addEntries(Arrays.asList(
                EntryFactory.makeEntry(
                        "s",
                        "March",
                        new GregorianCalendar(2019, 3, 20).getTimeInMillis(),
                        new GregorianCalendar(2019, 3, 22).getTimeInMillis(),
                        Color.GREEN),
                EntryFactory.makeEntry(
                        "1",
                        "Hello Motto",
                ...
                EntryFactory.makeEntry(
                        "3",
                        "Hey",
                        new GregorianCalendar(2019, 4, 20).getTimeInMillis(),
                        new GregorianCalendar(2019, 4, 20).getTimeInMillis(),
                        Color.GREEN),
                EntryFactory.makeEntry(
                        "adf",
                        "June",
                        new GregorianCalendar(2019, 5, 10).getTimeInMillis(),
                        new GregorianCalendar(2019, 5, 10).getTimeInMillis(),
                        Color.GREEN)
        ));
        ...
        tiledMonth.setTiledMonthEventListener(new OnTiledMonthEventListener() {
            @Override
            public void onCellClick(long date, List<String> tileIDs, boolean selectedDateChanged, boolean monthChanged) {
                int i = 0;
            }
